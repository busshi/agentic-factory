  ...
  return (
    <svg viewBox="0 0 380 220" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(0 31)">
        <text x="90" y="26" fontFamily="JetBrains Mono, monospace" fontSize="11" fill="rgb(var(--color-muted2))" textAnchor="middle">{s.received}</text>
        <text x="210" y="26" fontFamily="JetBrains Mono, monospace" fontSize="11" fill="rgb(var(--color-muted2))" textAnchor="middle">{s.analysis}</text>
        <text x="318" y="26" fontFamily="JetBrains Mono, monospace" fontSize="11" fill="rgb(var(--color-muted2))" textAnchor="middle">{s.reply}</text>
        ...
        <g>
          <rect x="26" y="46" width="128" height="50" rx="14" fill="rgb(var(--color-surface))" stroke="rgb(var(--color-line))" strokeWidth="1.5" />
          <path d="M 46 96 l -10 14 l 20 -8 z" fill="rgb(var(--color-surface))" stroke="rgb(var(--color-line))" strokeWidth="1.5" />
          <AnimatePresence mode="wait">
            ...
            >
              <text x="42" y="68" fontFamily="Inter, sans-serif" fontSize="10.5" fill="rgb(var(--color-text))">
                {question?.[0]}
              </text>
              <text x="42" y="84" fontFamily="Inter, sans-serif" fontSize="10.5" fill="rgb(var(--color-text))">
                {question?.[1]}
              </text>
            </motion.g>
          </AnimatePresence>
