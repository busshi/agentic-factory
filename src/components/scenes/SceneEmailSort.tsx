  ...
  return (
    <svg viewBox="0 0 380 220" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(40 100)">
        <rect x="-34" y="-24" width="68" height="48" rx="7" fill="rgb(var(--color-surface))" stroke="rgb(var(--color-line))" strokeWidth="1.5" />
        <path d="M -34 -17 L 0 8 L 34 -17" stroke="rgb(var(--color-line))" strokeWidth="1.3" fill="none" />
      </g>
      <text x="40" y="140" fontFamily="JetBrains Mono, monospace" fontSize="11" fill="rgb(var(--color-muted2))" textAnchor="middle">
        {lang === 'fr' ? 'inbox' : 'inbox'}
      </text>
      ...
      <g transform="translate(304 62)">
        <path d="M -32 -17 h 22 l 6 8 h 36 v 32 h -64 z" fill="rgb(var(--color-surface))" stroke="rgb(var(--color-blue))" strokeWidth="1.4" />
        <text y="38" fontFamily="JetBrains Mono, monospace" fontSize="11" fill="rgb(var(--color-blue-soft))" textAnchor="middle">
          {lang === 'fr' ? 'traité' : 'handled'}
        </text>
      </g>
      {/* folder: urgent */}
      <g transform="translate(304 142)">
        <path d="M -32 -17 h 22 l 6 8 h 36 v 32 h -64 z" fill="rgb(var(--color-surface))" stroke="rgb(var(--color-violet))" strokeWidth="1.4" />
        <text y="38" fontFamily="JetBrains Mono, monospace" fontSize="11" fill="rgb(var(--color-violet-soft))" textAnchor="middle">
