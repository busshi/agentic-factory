...
export const translations: Record<Lang, Translation> = {
  fr: {
    ...
    valueProp: {
      ...
      cards: [
        ...
        {
          title: 'Pensé pour la production, pas pour la démo',
          text: 'De bout en bout — interface, logique métier, infrastructure — un agent qui tourne réellement en production, pas une démo qui impressionne en réunion puis reste dans les cartons.',
        },
      ],
    },
    useCases: {
      ...
      cases: [
        ...
        },
        {
          ...
          text: "Chaque lead entrant (site, formulaire, waitlist) est enrichi et priorisé automatiquement avant qu’un humain n’y touche. L’équipe commerciale ne voit que ce qui vaut vraiment un appel.",
        },
        {
    ...
    credibility: {
      ...
      text: "Chaque agent que je livre est codé sur-mesure autour de l’API Claude et branché sur vos outils réels — pensé pour durer, pas pour impressionner en démo et lâcher au premier pic d’activité. Hébergé sur des infrastructures cloud fiables, il continue de tourner même quand votre activité s’accélère.",
  ...
  en: {
    ...
    hero: {
      eyebrow: 'AI Agents',
      titleA: 'Your repetitive tasks deserve better than a no-code hack.',
    ...
    valueProp: {
      ...
      cards: [
        ...
        },
        {
          ...
          text: 'End to end — interface, business logic, infrastructure — an agent that actually runs in production, not a demo that impresses in a meeting and then gathers dust.',
        },
      ],
    },
    useCases: {
    ...
    credibility: {
      ...
      text: "Every agent I ship is custom-built around the Claude API and wired into your real tools — made to last, not to impress in a demo and fall over at the first real spike in activity. Hosted on reliable cloud infrastructure, it keeps running even as your activity scales up.",
